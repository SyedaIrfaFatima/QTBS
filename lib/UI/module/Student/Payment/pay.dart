...
class _payfeeState extends State<payfee> {
  ...
  Future<void> fetchUserId(String email) async {
    ...
    userId = userQuery.docs.isNotEmpty ? userQuery.docs.first.id : '';
  }
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: Colors
                      .black26, // Change to your preferred light grey color
                  borderRadius: BorderRadius.circular(8),
                ),
                child: Container(
                  padding: const EdgeInsets.all(8),
                    ...
                    Row(
                      ...
                      children: [
                        buildPaymentOption(
                          ...
                          label: 'Cash',
                          onPressed: navigateToVoucherPage,
                        ),
                        SizedBox(width: 20),
                        buildPaymentOption(
                          icon: 'assets/jazzcash.png',
                          label: 'Jazz Cash',
                          onPressed: navigateToJazzCashPage,
                        ),
                      ],
                    ),
                  ],
